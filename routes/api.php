...
use App\Modules\Auth\Controllers\TechnicianApplicantAuthController;
...
use App\Modules\TechnicianApplication\Controllers\AdminTechnicianApplicationController;
use App\Modules\TechnicianApplication\Controllers\TechnicianApplicationController;
...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/technician/google/exchange', [GoogleTechnicianAuthController::class, 'exchange']);
    Route::post('/technician/register', [TechnicianApplicantAuthController::class, 'register']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:technician_applicant')
        ->group(function () {
            Route::post('/technician-applications', [
                TechnicianApplicationController::class,
                'store',
            ]);
            Route::get('/technician-applications/me', [
                TechnicianApplicationController::class,
                'mine',
            ]);
            Route::get('/technician-applications/me/documents', [
                TechnicianApplicationController::class,
                'documents',
            ]);
            Route::post('/technician-applications/me/documents', [
                TechnicianApplicationController::class,
                'uploadDocument',
            ]);
            Route::delete('/technician-applications/me/documents/{document}', [
                TechnicianApplicationController::class,
                'deleteDocument',
            ]);
        });
    ...
    Route::middleware('role:customer,technician_applicant,agent,admin,dispatcher,supervisor')->group(function () {
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('/admin/technician-applications', [
            AdminTechnicianApplicationController::class,
            'index',
        ]);
        Route::get('/admin/technician-applications/{technicianApplication}/documents/{document}/view', [
            AdminTechnicianApplicationController::class,
            'viewDocument',
        ]);
        Route::get('/admin/technician-applications/{technicianApplication}', [
            AdminTechnicianApplicationController::class,
            'show',
        ]);
        Route::patch('/admin/technician-applications/{technicianApplication}/status', [
            AdminTechnicianApplicationController::class,
            'updateStatus',
        ]);
        Route::post('/admin/technician-applications/{technicianApplication}/approve', [
            AdminTechnicianApplicationController::class,
            'approve',
        ]);
    });
